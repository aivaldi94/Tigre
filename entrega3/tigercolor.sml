...
struct
	...
	fun addEdge (u,v) = let
						...
						in ((if not (u = v) andalso not (areAdj(u,v)) then 
													 (print("no son iguales ni adjacentes\n");
	...
	fun combine (u,v) = let 
							val _ = print ("Entrando a combine\n")
