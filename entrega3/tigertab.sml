...
(* busca la clave x en t y retorna el valor asociado
    Si no encuentra el valor, falla.
    Debe ser únicamente utilizado cuando el valor está en la tabla*)
